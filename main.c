...
void insertarOrdenando (int a[], int v, int dato);
void strings();
...
void arreglosClase10 ()
{
    ...
    ordenarInsertando(datos, numeros);

    printf("\n Datos ingresados ordenados: \n");
    muestraArreglo(datos, numeros);
...
void ordenarInsertando (int a[], int v)
{
    int i = 0;
    while ( i < v - 1){
        insertarOrdenando(a, i, a[i+1]);
        i++;
    }
}
